...
const importYdkBtn = document.getElementById('import-ydk');
const importYdkeBtn = document.getElementById('import-ydke');
const ydkFileInput = document.getElementById('ydk-file-input');
const importStatus = document.getElementById('import-status');
const deckPointsSpan = document.getElementById('deck-points');
// YDKE modal elements
const ydkeModalBackdrop = document.getElementById('ydke-modal-backdrop');
const ydkeModalInput = document.getElementById('ydke-modal-input');
const ydkeModalError = document.getElementById('ydke-modal-error');
const ydkeModalImport = document.getElementById('ydke-modal-import');
const ydkeModalClose = document.getElementById('ydke-modal-close');
const ydkeModalCancel = document.getElementById('ydke-modal-cancel');
// (Removed) lflist/allowlist importers
const importLflistBtn = document.getElementById('import-lflist');
const lflistFileInput = document.getElementById('lflist-file-input');
const importAllowlistBtn = document.getElementById('import-allowlist');
const allowlistFileInput = document.getElementById('allowlist-file-input');

// Data stores
const cardDatabase = new Map(); // name -> card
const idToCard = new Map();     // id -> card
let allCards = [];
// Points: read from API misc_info only
// Active imported lflist state
const importedLimits = new Map(); // id -> 0/1/2/3
let importedPool = null; // Set<number> when a cardpool is defined by the lflist
let importedListTitle = '';
let importedBanlistOption = null; // <option> node inserted dynamically for imported list
// Active imported allowlist state (Genesys points override)
const importedAllowPoints = new Map(); // id -> points
let importedAllowMax = null; // number | null
let importedAllowTitle = '';
let importedAllowOption = null; // dynamic <option> for allowlist
